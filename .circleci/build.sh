...
git clone --depth=1 https://github.com/Prashant-1695/Flashable_Zip.git AnyKernel
echo "Done"
...
export ARCH=arm64
export LOCALVERSION="-${VERSION}-HMP"
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 neXus-V11.1-HMP-${CAMERA}-kernel-lavender-${TANGGAL}.zip *
    cd ..
}
sticker
sendinfo
